...
# ==========================================
# PERBAIKAN DIREKTORI (TERMASUK ZIVPN)
# ==========================================
directories=(
...
files=(
    ...
    /etc/zivpn/.zivpn.db /etc/xray/zivpn/.zivpn.db
)
...
# ==========================================
# PERBAIKAN PAKET (DENGAN DOS2UNIX DI AWAL)
# ==========================================
apt update -y
apt install -y dos2unix  # WAJIB DI AWAL
packages=(
...
# ==========================================
# MODIFIKASI: INSTALASI MENU + DOS2UNIX MASSAL
# ==========================================
...
# Fix format sebelum dipindah
dos2unix * >/dev/null 2>&1
chmod +x * >/dev/null 2>&1
mv * /usr/bin >/dev/null 2>&1

# ==========================================
# MODIFIKASI: INSTALASI ZIVPN CORE & API FIX
# ==========================================
...
# FIX API ZIVPN: Sinkronisasi key agar file 'apicreate' berhasil
mkdir -p /etc/zivpn
echo "Tunnelftdor" > /etc/zivpn/apikey
echo "8080" > /etc/zivpn/api_port
# Samakan database agar apicreate tidak 404
cp /etc/xray/zivpn/.zivpn.db /etc/zivpn/.zivpn.db 2>/dev/null

# ==========================================
# 100% KODE ASLI - CONFIG DOWNLOADS
# ==========================================
