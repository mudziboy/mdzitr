...
directories=(
    ...
    /etc/zivpn # MODIFIKASI: Folder untuk API ZiVPN
)
...
files=(
    ...
    /etc/zivpn/.zivpn.db # MODIFIKASI: DB ZiVPN sesuai jalur apicreate
)
...
# ==========================================
apt update -y
apt install -y dos2unix wget curl zip unzip p7zip-full jq # MODIFIKASI: Wajib di awal
...
# ==========================================
# Extraction & MODIFIKASI PERBAIKAN ZIVPN
# ==========================================
...
print_rainbow "Fixing menu formats..."
dos2unix * >/dev/null 2>&1
chmod +x * >/dev/null 2>&1
mv * /usr/bin >/dev/null 2>&1

# MODIFIKASI: Instalasi Core ZiVPN
...
/usr/bin/install-zivpn.sh # WAJIB: Gunakan versi tanpa reboot prematur!

# FIX API ZIVPN: Sinkronisasi apikey agar 'apicreate' berhasil
mkdir -p /etc/zivpn
...
# ==========================================
# MODIFIKASI: FINALIZING SERVICES
# ==========================================
services=(
